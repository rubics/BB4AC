package app.aircrew.view.screens;
...
import app.aircrew.view.fields.DashboardItem;
import app.aircrew.view.fields.ScreenTitle;
import app.aircrew.view.managers.chat.ChatScreenManager;
import app.aircrew.view.managers.deals.DealsScreenManager;
import app.aircrew.view.managers.profile.ProfileInfoScreenManager;
import app.aircrew.view.screens.chat.ChatScreen;
import app.aircrew.view.screens.favorites.FavoritesScreen;
	...
	private DashboardScreen(){
		...
		logoutButton.setChangeListener(new FieldChangeListener() {
			...
			public void fieldChanged(Field field, int context) {
				...
				AirCrewApp.userController.pushSignInScreen();
			}
		});
